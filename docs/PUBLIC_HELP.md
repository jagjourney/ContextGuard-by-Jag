...
The app should eventually check for updates in the background, show the available
version, explain what changed, download the signed update, install it, and
relaunch when the person approves.
